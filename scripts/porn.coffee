...
#   HUBOT_PORN_CSE_ID - The ID of your Custom Search Engine
#
# Commands:
#   hubot gyfcat me <query> - Gets a Gfycatporn.com animation.

module.exports = (robot) ->
  robot.hear /^porn me (.*)/i, (msg) ->
...
imageMe = (msg, query, animated, faces, cb) ->
  ...
  googleCseId = process.env.HUBOT_PORN_CSE_ID
  if googleCseId
